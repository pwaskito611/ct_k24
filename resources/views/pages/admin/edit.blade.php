...
<div class="container">
    <form class="mt-4" action="{{url('/admin/update')}}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('put')
        ...
        <a href="{{url('admin/dashboard')}}" class="btn btn-secondary ms-2 mb-4">Back to dashboard</a>
